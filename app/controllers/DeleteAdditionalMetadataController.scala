...
class DeleteAdditionalMetadataController @Inject()(val consignmentService: ConsignmentService,
  ...
  def deleteAdditionalMetadata(consignmentId: UUID, fileIds: List[UUID]): Action[AnyContent] = standardTypeAction(consignmentId) {
