...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.58",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.78-SNAPSHOT",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.264",
