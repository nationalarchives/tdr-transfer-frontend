...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.114",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.145",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.337-SNAPSHOT",
