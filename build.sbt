...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.236",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.248",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.417",
  "uk.gov.nationalarchives" % "da-metadata-schema_2.13" % "0.0.64",
  "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.150",
  "uk.gov.nationalarchives" %% "s3-utils" % "0.1.281",
  "uk.gov.nationalarchives" %% "sns-utils" % "0.1.281",
