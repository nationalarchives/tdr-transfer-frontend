...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.191",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.218",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.391",
  "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.77",
  "uk.gov.nationalarchives" %% "s3-utils" % "0.1.216",
  "uk.gov.nationalarchives" %% "sns-utils" % "0.1.216",
