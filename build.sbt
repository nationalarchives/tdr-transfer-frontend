...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.93",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.118",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.313-SNAPSHOT",
