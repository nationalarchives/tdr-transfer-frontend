...
libraryDependencies ++= Seq(
  ...
  "software.amazon.awssdk" % "lambda" % "2.19.13",
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.82",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.109-SNAPSHOT",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.296",
