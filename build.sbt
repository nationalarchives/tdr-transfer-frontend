...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.45",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.68",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.250-SNAPSHOT",
  ws,
