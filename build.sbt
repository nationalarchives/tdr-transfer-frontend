...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.112",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.140",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.334-SNAPSHOT",
