...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.90",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.113",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.308-SNAPSHOT",
