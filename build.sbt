...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.47",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.71",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.254",
  ws,
