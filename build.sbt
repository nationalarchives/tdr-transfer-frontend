...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.216",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.233",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.402",
  "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.108",
  "uk.gov.nationalarchives" %% "s3-utils" % "0.1.234",
  "uk.gov.nationalarchives" %% "sns-utils" % "0.1.234",
