...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.73",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.99",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.284-SNAPSHOT",
