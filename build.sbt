...
libraryDependencies ++= Seq(
  ...
  "io.opentelemetry.contrib" % "opentelemetry-aws-xray" % "1.58.0",
...
dependencyOverrides += "com.fasterxml.jackson.core" % "jackson-databind" % "2.21.4"
dependencyOverrides += "com.fasterxml.jackson.core" % "jackson-core" % "2.21.4"
