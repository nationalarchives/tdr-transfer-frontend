...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.239",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.409-SNAPSHOT",
  "uk.gov.nationalarchives" % "da-metadata-schema_3" % "0.0.56",
  "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.126",
  "uk.gov.nationalarchives" %% "s3-utils" % "0.1.252",
  "uk.gov.nationalarchives" %% "sns-utils" % "0.1.252",
