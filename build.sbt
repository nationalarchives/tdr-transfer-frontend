...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.110",
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.139",
  "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.332-SNAPSHOT",
