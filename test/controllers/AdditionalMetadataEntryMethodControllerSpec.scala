...
class AdditionalMetadataEntryMethodControllerSpec extends FrontEndTestHelper {
  ...
  "AdditionalMetadataEntryMethodControllerSpec GET" should {
  ...
  private def instantiateController(
    ...
    new AdditionalMetadataEntryMethodController(securityComponents, keycloakConfiguration, frontEndInfoConfiguration, consignmentService, applicationConfig)
  }
}
