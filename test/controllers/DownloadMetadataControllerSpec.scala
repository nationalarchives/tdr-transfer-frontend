...
class DownloadMetadataControllerSpec extends FrontEndTestHelper {
  ...
  "DownloadMetadataController downloadMetadataPage GET" should {
    "load the download metadata page with the image, download link, next button and back button" in {
      ...
      responseAsString must include(s"""<p class="govuk-body">If you would like to add or amend the metadata, return to <a href="/consignment/$consignmentId/draft-metadata/prepare-metadata" class="govuk-link">prepare your metadata.</a></p>""")
