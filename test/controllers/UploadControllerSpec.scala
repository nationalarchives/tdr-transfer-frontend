...
class UploadControllerSpec extends FrontEndTestHelper {
  ...
  private def checkForExpectedPageContentOnMainUploadPage(pageAsString: String): Unit = {
    ...
    pageAsString must include("""<div aria-labelledby="upload-records-progress-label" class="progress-display" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">""")
  }
