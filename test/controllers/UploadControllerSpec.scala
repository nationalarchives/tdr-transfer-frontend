...
//import services.{BackendChecksService, ConsignmentService, DynamoService, S3Service, UploadService}
...
//      val uploadService = new UploadService(applicationConfig)
...
//      val graphQLConfiguration: GraphQLConfiguration = new GraphQLConfiguration(app.configuration)
//      val uploadService = new UploadService(applicationConfig, dynamoService)
//      val consignmentService: ConsignmentService = new ConsignmentService(dynamoService, new S3Service())
//      val backendChecksService = new BackendChecksService(new InternalWSClient("http", 9007), app.configuration)
//      val consignmentId = UUID.fromString("c2efd3e6-6664-4582-8c28-dcf891f60e68")
//      val controller = new UploadController(
//        dynamoService,
