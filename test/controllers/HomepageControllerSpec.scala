...
class HomepageControllerSpec extends FrontEndTestHelper {
  ...
  private def checkForContentOnHomepagePage(pageAsString: String, userType: String = "standard"): Unit = {
    ...
    if (userType == "judgment") {
      ...
      pageAsString must include("""<p class="govuk-body">Once you have successfully completed the transfer you will need to email us. More information will be provided after the transfer.</p>""")
